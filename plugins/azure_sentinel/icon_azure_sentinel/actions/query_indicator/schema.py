...
class QueryIndicatorInput(insightconnect_plugin_runtime.Input):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    ...
    "skipToken": {
      "type": "string",
      "title": "Skip Token",
      "description": "Filter by skip token",
      "order": 13
    },
    "sortBy": {
      "type": "array",
...
class QueryIndicatorOutput(insightconnect_plugin_runtime.Output):
    schema = json.loads("""
   {
  "type": "object",
  "title": "Variables",
  "properties": {
    "indicators": {
      ...
      "items": {
        "$ref": "#/definitions/ThreatIntelligenceIndicators"
      },
      "order": 1
    }
  },
  ...
  "definitions": {
    ...
    "ThreatIntelligenceIndicators": {
      "type": "object",
      "title": "ThreatIntelligenceIndicators",
      "properties": {
        "etag": {
          "type": "string",
          "title": "Etag",
